function showTime() { 
	...
	var startDate = new Date(2019, 9, 9);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear 邓玲:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----李凯   2019-10-09</c>"; 
