function showTime() { 
	...
	var startDate = new Date(2018, 0, 24);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear 沈风鑫:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----Lik   2018-02-14</c>"; 
